...
import com.nemuria.miya.data.local.AiScheduleEntity
...
class ScheduleRepositoryImpl @Inject constructor(
    ...
    private fun AiScheduleEntity.toDomainModel() = AiSchedule(
        id = id,
        date = date,
        startTime = startTime,
        title = title,
    ...
    private fun AiSchedule.toEntity() = AiScheduleEntity(
        id = id,
        date = date,
        startTime = startTime,
        title = title,
